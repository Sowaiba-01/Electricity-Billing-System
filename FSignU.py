...
"border-bottom:1px solid black;")
        ref_no_1 = str(randint(1, 5000))
        self.RefNo.setText(ref_no_1)
        self.RefNo.setReadOnly(True)
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.H_No.setPlaceholderText(_translate("Dialog", "Enter your House No"))
        ...
        self.Street_No.setPlaceholderText(_translate("Dialog", "Enter your Street No"))
        ...
        self.label.setText(_translate("Dialog", "Sign Up to Start Paying Bills without any problem"))
        self.checkBox.setText(_translate("Dialog", "Creating an account means you are okay with our Privacy Policy and our Terms and Conditions."))
        ...
        if self.F_Name.text() == "" or self.MeterNo.text() == "" or self.Passwrd.text() == "" or self.checkBox.isChecked()==False:
            ...
            try:
                ...
                with cx_Oracle.connect('system/Oracle123') as co:
                    ...
                    co.commit()
                msg = QMessageBox()
                msg.setText("Congratualtions! On becoming IESCO member")
